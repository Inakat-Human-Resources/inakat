...
interface Testimonial {
  ...
  bg_testimonial: string;
  name_font_color: string;
  role_font_color: string;
}
...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    comment:
      "Desde que comenzamos a trabajar con el equipo de reclutamiento, hemos experimentado una notable mejora en la calidad de nuestros nuevos empleados. Su capacidad para encontrar candidatos que no solo tienen las habilidades técnicas necesarias, sino también el ajuste cultural adecuado, ha tenido un impacto positivo en nuestro equipo y en nuestros resultados empresariales.",
    image: customer3,
    bg_testimonial: "bg-white",
    name_font_color: "text-title-dark",
    role_font_color: "text-gray-600",
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className={`${testimonial.bg_testimonial} p-10 rounded-[30px] shadow-lg relative`}
            >
              ...
              <div className="mb-6">
                <h3 className={`font-bold ${testimonial.name_font_color}`}>
                  {testimonial.name}
                </h3>
                <p className={`${testimonial.role_font_color}`}>
                  {testimonial.role}
                </p>
                <p className={`${testimonial.role_font_color}`}>
                  {testimonial.company}
              ...
              <p className={`${testimonial.name_font_color}`}>
                {testimonial.comment}
              </p>
              ...
              <div
                ...
                style={{
                  ...
                  borderTop: `20px solid ${
                    testimonial.bg_testimonial === "bg-white"
                      ? "#ffffff"
                      : "#f48602"
                  }`,
                }}
