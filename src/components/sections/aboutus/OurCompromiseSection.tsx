      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center min-h-[80%]">
          ...
          <p className="text-white text-left">
            ...
            <ul className="list-disc pl-6">
              <li className="font-bold">
                Psicólogos expertos evalúan actitudes, valores, formas de
                trabajo, claridad de intención y compatibilidad cultural.
              </li>
              <li className="font-bold">
                Especialistas técnicos validan habilidades, experiencia y nivel
                de ejecución.
              </li>
            </ul>
            <br />
            La tecnología y la inteligencia artificial nos ayudan a detectar
            señales relevantes, pero{" "}
            <span className="font-bold">
              cada paso, cada filtro y cada elección está pensada y ejecutada
              por personas expertas.{" "}
            </span>
          </p>
        </div>

        {/* Second column: With Transparency */}
        <div className="bg-custom-beige p-8 rounded-lg shadow-lg flex items-center justify-start max-w-md flex-1 h-full">
          <p className="text-black text-left">
            ...
            <br />
            Y si encontramos una gran oportunidad para tu empresa, también te
            lo decimos con argumentos.
            <br />
            No ofrecemos fórmulas genéricas ni promesas vacías.
            <br />
            Ofrecemos claridad, criterio y compromiso para ayudarte a elegir
            bien.
          </p>
        </div>
