// RUTA: src/app/company/error.tsx
// PERF-006: error boundary del panel.
// Se pinta DENTRO del AppShell (lo pone company/layout.tsx): nada de pantalla
...
export default function CompanyError({
  ...
  return <ErrorDePanel titulo="Error en el panel de empresa" frase="Algo no salió como esperábamos." alReintentar={reset} />;
}
