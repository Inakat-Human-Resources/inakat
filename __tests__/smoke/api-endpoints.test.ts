...
jest.mock('@/lib/rate-limit', () => ({
  ...
  // Contadores que sólo gastan los fallos (login) o las altas creadas (register)
  peekRateLimit: jest.fn(() => ({ success: true, remaining: 10, resetInSeconds: 60 })),
  consumeRateLimit: jest.fn(),
  resetRateLimit: jest.fn(),
  hashIdentifier: jest.fn((value: string) => String(value)),
  rateLimitResponse: jest.fn(() => ({ status: 429 })),
  getClientIP: jest.fn(() => '127.0.0.1'),
  LOGIN_RATE_LIMIT: { maxRequests: 7, windowSeconds: 900 },
  LOGIN_EMAIL_RATE_LIMIT: { maxRequests: 10, windowSeconds: 900 },
  REGISTER_RATE_LIMIT: { maxRequests: 3, windowSeconds: 3600 },
  REGISTER_ATTEMPT_RATE_LIMIT: { maxRequests: 20, windowSeconds: 3600 },
  FORGOT_PASSWORD_RATE_LIMIT: { maxRequests: 3, windowSeconds: 3600 },
  FORGOT_PASSWORD_EMAIL_RATE_LIMIT: { maxRequests: 3, windowSeconds: 3600 },
  RESET_PASSWORD_RATE_LIMIT: { maxRequests: 5, windowSeconds: 900 },
  DISCOUNT_VALIDATE_RATE_LIMIT: { maxRequests: 10, windowSeconds: 900 },
